...
var tt_text = "Welcome to the night sky. It is much more visible ^without the city lights, don't you think? ^^My words flow using simple Javascript. ^The stars, however, fly with Javascript vectors/functions derived from upper-level physics and math. ^Click anywhere to the right to open gravity holes.^Feel free to play with the controls in the upper right corner, too.^^I enjoy poetry, so here is a poem by Ms. Dietrich entitled 'A Tale Of Fire and Ice':^^^{18}Part I: Ice^^{12}He shines like silver midnight moon -^cool marble statue, this tycoon.^And though he makes the ladies swoon,^of ice he's hewn.; of ice he's hewn.^^He's poker-faced and can deceive^competitors and can achieve^most anything, but can't conceive^of Genevieve, of Genevieve.^^Like Neptune, distant from the sun -^relationships he chose to shun.^He thought the search for love was done.^He has no one; he has no one.^^Now love's allure has come his way.^What will he do? What will he say?^ Will he grab hold, beg love to stay,^ or let it stray? Or let it stray?^^{20}Part II: Fire^^{12}This dragoness disguised in lace -^passion's flower with angel's face,^ precisely picks the time and place^each dream to chase, each dream to chase.^^Like ink the color red, she stains^the hearts of those whose love she drains,^ and then she leaves when naught remains^No lust she feigns; no lust she feigns.^^And now there's one who would suffice.^For him alone, she'd sacrifice^her everything, so he of ice^she must entice, she must entice.^^So Genevieve now strikes the flame.^Will man of ice his love proclaim?^Beneath her fire and his cold frame,^ they're both the same. They're both the same.^^^{20}Thanks for stopping by to listen! I hope you liked it! Bye!";
...
/*
Begin Pre-code loading required for gravity animation gui, stops at "requestAnimationFrame"
*/
...
(function() {
    ...
    var BACKGROUND_COLOR      = 'rgba(34, 34, 34, 1)',
        PARTICLE_RADIUS       = 1,
        G_POINT_RADIUS        = 10,
